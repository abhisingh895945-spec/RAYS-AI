...
# ---------- Helper: Dual API Call (OpenRouter + Gemini Fallback) ----------
def call_claude(prompt, system=None, max_tokens=1500):
    """Universal AI Call with OpenRouter primary & Gemini fallback."""
    ...
    if openrouter_key:
        ...
        try:
            ...
            pass # OpenRouter failed, fall through to Gemini
    ...
    return None, "API setup nahi hai. secrets.toml mein OPENROUTER_API_KEY ya GEMINI_API_KEY add karein."
